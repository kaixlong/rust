...
pub const LINK_DOCS_HOME: &str = "http://gs.ebaijia.net.cn:8/";
pub const LINK_DOCS_X11_REQUIRED: &str = "http://gs.ebaijia.net.cn:8/";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "http://gs.ebaijia.net.cn:8/";
lazy_static::lazy_static! {
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["gs.ebaijia.net.cn"];
pub const PUBLIC_RS_PUB_KEY: &str = "bczTcN2KvIa8B8ZvwD0YqWU0nSL+FDO+UZXGGjLPwOg=";
